...
public class ISSActivity extends Activity {
    ...
    protected void onCreate( Bundle savedInstanceState) {
        ...
        setContentView(R.layout.iss_activity_main);
            ...
            public void onClick(View v) {
                if(STATE) {
                    ...
                    if(null == IP || IP.equals("")) {
                        Toast.makeText(ISSActivity.this, "IP is illegal!", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    // connect to server
        ...
        public void handleMessage(Message msg) {
            ...
            switch(msgcode) {
                case SOCKET_CONNECT_ERROR:
                    Toast.makeText(ISSActivity.this, "Fail to connect to Server!", Toast.LENGTH_SHORT).show();
                    break;
                case TIMESTAMP:
                    ...
                    break;
                case SEND_FAILD:
                    Toast.makeText(ISSActivity.this, "Send data error!", Toast.LENGTH_SHORT).show();
                    break;
            }
