...
public class MDialPCActivity extends Activity {
    ...
    SensorClass sensorClass = null;

    @Override
    protected void onCreate( Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.mdialpc_activity_main);
            ...
            public void onClick(View v) {
                if(STATE) {
                    ...
                    if(null == IP || IP.equals("")) {
                        Toast.makeText(MDialPCActivity.this, "IP is illegal!", Toast.LENGTH_SHORT).show();
                        return;
                    }
                    // connect to server
                    ...
                    editor.commit();
                    //register sensors
                    sensorClass = new SensorClass(sensorManager, issHandler, socketClientThread.sockhandler);
        ...
        public void handleMessage(Message msg) {
            ...
            switch(msgcode) {
                case SOCKET_CONNECT_ERROR:
                    Toast.makeText(MDialPCActivity.this, "Fail to connect to Server!", Toast.LENGTH_SHORT).show();
                    break;
                case TIMESTAMP:
                    ...
                    break;
                case SEND_FAILD:
                    Toast.makeText(MDialPCActivity.this, "Send data error!", Toast.LENGTH_SHORT).show();
